...
from . models import Product, Category, ProductReview, Spoon
...
def category_detail(request, slug):
    ...
    # products = category.products.filter(variants=None)
